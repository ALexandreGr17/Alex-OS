...
void setcursor(int x, int y)
{
    ...
    i686_outb(VGA_CRT_ADDRESS_PORT, 0x0F);  // 0xf -> cursor location low
    i686_outb(VGA_CRT_DATA_PORT, (uint8_t)(pos & 0xFF)); // first Byte of location
    i686_outb(VGA_CRT_ADDRESS_PORT, 0x0E); // 0xe -> cursor location high
    i686_outb(VGA_CRT_DATA_PORT, (uint8_t)((pos >> 8) & 0xFF)); // second Byte ogf location
}
